...
void Data_MC_comparison_fullperiod(string MC_prod, string period, string apass){
  
  gROOT->SetBatch(kTRUE);
  gStyle->SetOptStat(0);
  
  //----------Input and Output directory - same directory of the config file
  char output_dir_name[1][200] = {"/home/sarapc/Desktop/MID_QC/ComparisonDataMC_A02D/PbPb2023_apass4"}; 
  ...
  //---------- Read data file
  if(gSystem->GetPathInfo(Form("%s/AnalysisResultsData_%s_%s.root",output_dir_name[0],period.c_str(),apass.c_str()),dummy1,dummy2,dummy3,dummy4) != 0) cout << "File Not Found! Try again" << endl;    
  file_in_data = new TFile(Form("%s/AnalysisResultsData_%s_%s.root",output_dir_name[0],period.c_str(),apass.c_str()),"read");
  //file_in_data = new TFile("AnalysisResultsData_LHC24an_apass1.root","read");
  printf("Open File data: %s\n",file_in_data->GetName());
  
  //---------- Read MC file
  if(gSystem->GetPathInfo(Form("%s/AnalysisResultsMC_%s_anchoredto_%s_%s.root",output_dir_name[0],MC_prod.c_str(),period.c_str(),apass.c_str()),dummy1,dummy2,dummy3,dummy4) != 0) cout << "File Not Found! Try again" << endl;    
  file_in_MC = new TFile(Form("%s/AnalysisResultsMC_%s_anchoredto_%s_%s.root",output_dir_name[0],MC_prod.c_str(),period.c_str(),apass.c_str()),"read");
  printf("Open File data: %s\n",file_in_MC->GetName());
  ...
  for(int i=0;i<2;i++){
   ...
   if(i==0){
    ...
    frame_etadistrib_comparison[i]->SetTitle("#eta distribution");
    ...
    hEta_matchedMchMid_data->SetTitle("#eta distribution");
    ...
    frame_etadistrib_comparison[i]->SetTitle("Ratio MC/data #eta distribution");
    frame_etadistrib_comparison[i]->GetXaxis()->SetTitle("#eta");
    ...
    hRatio_Eta_matchedMchMid_MC_data->SetTitle("Ratio MC/data #eta distribution");
  ...
  for(int i=0;i<2;i++){
   ...
   if(i==0){
    ...
    frame_phidistrib_comparison[i]->SetTitle("#phi distribution");
    ...
    hPhi_matchedMchMid_data->SetTitle("#phi distribution");
    ...
    frame_phidistrib_comparison[i]->SetTitle("Ratio MC/data #phi distribution");
    frame_phidistrib_comparison[i]->GetXaxis()->SetTitle("#phi (rad.)");
    ...
    hRatio_Phi_matchedMchMid_MC_data->SetTitle("Ratio MC/data #phi distribution");
  ...
  for(int i=0;i<2;i++){
   ...
   if(i==0){
    ...
    frame_ptdistrib_comparison[i]->SetTitle("#it{p}_{T} distribution");
    ...
    hPt_matchedMchMid_data->SetTitle("#it{p}_{T} distribution");
    ...
    frame_ptdistrib_comparison[i]->SetTitle("Ratio MC/data #it{p}_{T} distribution");
    frame_ptdistrib_comparison[i]->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
    ...
    hRatio_Pt_matchedMchMid_MC_data->SetTitle("Ratio MC/data #it{p}_{T} distribution");
  ...
  for(int i=0;i<2;i++){
   ...
   if(i==0){
    ...
    frame_etadistrib_comparison_ptsel[i]->SetTitle("#eta distribution");
    ...
    hEta_matchedMchMid_ptsel_data->SetTitle("#eta distribution");
    ...
    frame_etadistrib_comparison_ptsel[i]->SetTitle("Ratio MC/data #eta distribution");
    frame_etadistrib_comparison_ptsel[i]->GetXaxis()->SetTitle("#eta");
    ...
    hRatio_Eta_matchedMchMid_ptsel_MC_data->SetTitle("Ratio MC/data #eta distribution");
  ...
  for(int i=0;i<2;i++){
   ...
   if(i==0){
    ...
    frame_phidistrib_comparison_ptsel[i]->SetTitle("#phi distribution");
    ...
    hPhi_matchedMchMid_ptsel_data->SetTitle("#phi distribution");
    ...
    frame_phidistrib_comparison_ptsel[i]->SetTitle("Ratio MC/data #phi distribution");
    frame_phidistrib_comparison_ptsel[i]->GetXaxis()->SetTitle("#phi (rad.)");
    ...
    hRatio_Phi_matchedMchMid_ptsel_MC_data->SetTitle("Ratio MC/data #phi distribution");
  ...
  for(int i=0;i<2;i++){
   ...
   if(i==0){
    ...
    frame_ptdistrib_comparison_ptsel[i]->SetTitle("#it{p}_{T} distribution");
    ...
    hPt_matchedMchMid_ptsel_data->SetTitle("#it{p}_{T} distribution");
    ...
    frame_ptdistrib_comparison_ptsel[i]->SetTitle("Ratio MC/data #it{p}_{T} distribution");
    frame_ptdistrib_comparison_ptsel[i]->GetXaxis()->SetTitle("#it{p}_{T} (GeV/#it{c})");
    ...
    hRatio_Pt_matchedMchMid_ptsel_MC_data->SetTitle("Ratio MC/data #it{p}_{T} distribution");
  ...
  can_etadistrib_comparison->Print(Form("%s/MCdata_comparison_MC_%s_data_%s_%s_fullperiod.pdf[",output_dir_name[0],MC_prod.c_str(),period.c_str(),apass.c_str()));
  can_etadistrib_comparison->Print(Form("%s/MCdata_comparison_MC_%s_data_%s_%s_fullperiod.pdf",output_dir_name[0],MC_prod.c_str(),period.c_str(),apass.c_str()));
  can_phidistrib_comparison->Print(Form("%s/MCdata_comparison_MC_%s_data_%s_%s_fullperiod.pdf",output_dir_name[0],MC_prod.c_str(),period.c_str(),apass.c_str()));
  can_ptdistrib_comparison->Print(Form("%s/MCdata_comparison_MC_%s_data_%s_%s_fullperiod.pdf",output_dir_name[0],MC_prod.c_str(),period.c_str(),apass.c_str()));
  can_etadistrib_comparison_ptsel->Print(Form("%s/MCdata_comparison_MC_%s_data_%s_%s_fullperiod.pdf",output_dir_name[0],MC_prod.c_str(),period.c_str(),apass.c_str()));
  can_phidistrib_comparison_ptsel->Print(Form("%s/MCdata_comparison_MC_%s_data_%s_%s_fullperiod.pdf",output_dir_name[0],MC_prod.c_str(),period.c_str(),apass.c_str()));
  can_ptdistrib_comparison_ptsel->Print(Form("%s/MCdata_comparison_MC_%s_data_%s_%s_fullperiod.pdf",output_dir_name[0],MC_prod.c_str(),period.c_str(),apass.c_str()));
  can_ptdistrib_comparison_ptsel->Print(Form("%s/MCdata_comparison_MC_%s_data_%s_%s_fullperiod.pdf]",output_dir_name[0],MC_prod.c_str(),period.c_str(),apass.c_str()));
  
  //can_etadistrib_comparison->Print(Form("%s/test.pdf[",period.c_str()));
  //can_etadistrib_comparison->Print(Form("%s/test.pdf",period.c_str()));
  //can_phidistrib_comparison->Print(Form("%s/test.pdf",period.c_str()));
  //can_ptdistrib_comparison->Print (Form("%s/test.pdf",period.c_str()));
  //can_etadistrib_comparison_ptsel->Print(Form("%s/test.pdf",period.c_str()));
  //can_phidistrib_comparison_ptsel->Print(Form("%s/test.pdf",period.c_str()));
  //can_ptdistrib_comparison_ptsel->Print (Form("%s/test.pdf",period.c_str()));
  //can_ptdistrib_comparison_ptsel->Print (Form("%s/test.pdf]",period.c_str()));
