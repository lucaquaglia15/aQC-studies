...
list1 = leggi_file('Run_list_CBT_muon.txt')
...
with open('common_run_list_data_MC_cbt_muon.txt', 'w') as output_file:
    for item in common_elements:
        output_file.write(item + '\n')

print("File with common elements 'common_run_list_data_MC_cbt_muon.txt' created!")
